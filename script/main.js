...
const firebaseConfig = {
  apiKey: 'AIzaSyA5C4pEmXKgOflKZkDu-RxI4E_K63daN9I',
  authDomain: 'bookstore-93385.firebaseapp.com',
  projectId: 'bookstore-93385',
  storageBucket: 'bookstore-93385.firebasestorage.app',
  messagingSenderId: '160976559821',
  appId: '1:160976559821:web:00c5d0032e9d0994521384',
  measurementId: 'G-FTKB8S7JG8',
};

const app = initializeApp(firebaseConfig);
const auth = getAuth(app);

// Show the role selection modal if it's the first time visiting
window.onload = () => {
...
// Set the role in localStorage and hide the modal
document.getElementById('adminRole').addEventListener('click', () => {
  localStorage.setItem('userRole', 'Admin');
  document.getElementById('roleModal').style.display = 'none';
});

document.getElementById('customerRole').addEventListener('click', () => {
...
registerForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    if (userRole === 'Admin') {
      ...
      window.location.href = 'index.html'; // Customer page
    }
  } catch (error) {
